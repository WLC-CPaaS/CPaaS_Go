...
public class PhoneNumberAPI {
   ...
   */
  public ServiceDocsAccountPhonenumberGetAll V1AccountAccountidPhonenumberGet(string accountid, string startKey, int32 pageSize) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ServiceDocsAccountPhonenumberGetAll V1AccountPhonenumberGet(string startKey, int32 pageSize) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public ServiceDocsPhonenumberSearchGetAll V1PhonenumberSearchGet(string areaCode, int32 quantity) throws ApiException {
    Object localVarPostBody = null;
