...
// checks if the ServiceDocsUserGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsUserGetAll{}

// ServiceDocsUserGetAll struct for ServiceDocsUserGetAll
type ServiceDocsUserGetAll struct {
	Data []ServiceUserOutputShort `json:"data,omitempty"`
...
func (o *ServiceDocsUserGetAll) GetData() []ServiceUserOutputShort {
	if o == nil || IsNil(o.Data) {
		var ret []ServiceUserOutputShort
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ServiceUserOutputShort and assigns it to the Data field.
...
func (o ServiceDocsUserGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsUserGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsUserGetAll struct {
	value *ServiceDocsUserGetAll
	isSet bool
}

func (v NullableServiceDocsUserGetAll) Get() *ServiceDocsUserGetAll {
	return v.value
}

func (v *NullableServiceDocsUserGetAll) Set(val *ServiceDocsUserGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsUserGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsUserGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsUserGetAll(val *ServiceDocsUserGetAll) *NullableServiceDocsUserGetAll {
	return &NullableServiceDocsUserGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsUserGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsUserGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
