...
// checks if the ServiceDocsWebhookGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsWebhookGetAll{}

// ServiceDocsWebhookGetAll struct for ServiceDocsWebhookGetAll
type ServiceDocsWebhookGetAll struct {
...
func (o ServiceDocsWebhookGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsWebhookGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsWebhookGetAll struct {
	value *ServiceDocsWebhookGetAll
	isSet bool
}

func (v NullableServiceDocsWebhookGetAll) Get() *ServiceDocsWebhookGetAll {
	return v.value
}

func (v *NullableServiceDocsWebhookGetAll) Set(val *ServiceDocsWebhookGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsWebhookGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsWebhookGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsWebhookGetAll(val *ServiceDocsWebhookGetAll) *NullableServiceDocsWebhookGetAll {
	return &NullableServiceDocsWebhookGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsWebhookGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsWebhookGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
