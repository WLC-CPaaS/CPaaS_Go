...
// checks if the ServiceVoicemailOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceVoicemailOutput{}

// ServiceVoicemailOutput struct for ServiceVoicemailOutput
type ServiceVoicemailOutput struct {
...
func (o ServiceVoicemailOutput) MarshalJSON() ([]byte, error) {
...
func (o ServiceVoicemailOutput) ToMap() (map[string]interface{}, error) {
...
type NullableServiceVoicemailOutput struct {
	value *ServiceVoicemailOutput
	isSet bool
}

func (v NullableServiceVoicemailOutput) Get() *ServiceVoicemailOutput {
	return v.value
}

func (v *NullableServiceVoicemailOutput) Set(val *ServiceVoicemailOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceVoicemailOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceVoicemailOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceVoicemailOutput(val *ServiceVoicemailOutput) *NullableServiceVoicemailOutput {
	return &NullableServiceVoicemailOutput{value: val, isSet: true}
}

func (v NullableServiceVoicemailOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceVoicemailOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
