...
// checks if the ServiceDocsDeviceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsDeviceStatus{}

// ServiceDocsDeviceStatus struct for ServiceDocsDeviceStatus
type ServiceDocsDeviceStatus struct {
	Data []ServiceDeviceStatusOutput `json:"data,omitempty"`
...
func (o *ServiceDocsDeviceStatus) GetData() []ServiceDeviceStatusOutput {
	if o == nil || IsNil(o.Data) {
		var ret []ServiceDeviceStatusOutput
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ServiceDeviceStatusOutput and assigns it to the Data field.
...
func (o ServiceDocsDeviceStatus) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsDeviceStatus) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsDeviceStatus struct {
	value *ServiceDocsDeviceStatus
	isSet bool
}

func (v NullableServiceDocsDeviceStatus) Get() *ServiceDocsDeviceStatus {
	return v.value
}

func (v *NullableServiceDocsDeviceStatus) Set(val *ServiceDocsDeviceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsDeviceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsDeviceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsDeviceStatus(val *ServiceDocsDeviceStatus) *NullableServiceDocsDeviceStatus {
	return &NullableServiceDocsDeviceStatus{value: val, isSet: true}
}

func (v NullableServiceDocsDeviceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsDeviceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
