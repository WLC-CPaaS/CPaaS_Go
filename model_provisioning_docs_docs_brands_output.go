...
// checks if the ProvisioningDocsDocsBrandsOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisioningDocsDocsBrandsOutput{}

// ProvisioningDocsDocsBrandsOutput struct for ProvisioningDocsDocsBrandsOutput
type ProvisioningDocsDocsBrandsOutput struct {
...
func NewProvisioningDocsDocsBrandsOutput() *ProvisioningDocsDocsBrandsOutput {
	this := ProvisioningDocsDocsBrandsOutput{}
	return &this
}
...
func (o ProvisioningDocsDocsBrandsOutput) MarshalJSON() ([]byte, error) {
...
func (o ProvisioningDocsDocsBrandsOutput) ToMap() (map[string]interface{}, error) {
...
type NullableProvisioningDocsDocsBrandsOutput struct {
	value *ProvisioningDocsDocsBrandsOutput
	isSet bool
}

func (v NullableProvisioningDocsDocsBrandsOutput) Get() *ProvisioningDocsDocsBrandsOutput {
	return v.value
}

func (v *NullableProvisioningDocsDocsBrandsOutput) Set(val *ProvisioningDocsDocsBrandsOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProvisioningDocsDocsBrandsOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProvisioningDocsDocsBrandsOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvisioningDocsDocsBrandsOutput(val *ProvisioningDocsDocsBrandsOutput) *NullableProvisioningDocsDocsBrandsOutput {
	return &NullableProvisioningDocsDocsBrandsOutput{value: val, isSet: true}
}

func (v NullableProvisioningDocsDocsBrandsOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvisioningDocsDocsBrandsOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
