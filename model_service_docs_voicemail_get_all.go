...
// checks if the ServiceDocsVoicemailGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsVoicemailGetAll{}
...
func NewServiceDocsVoicemailGetAll() *ServiceDocsVoicemailGetAll {
	this := ServiceDocsVoicemailGetAll{}
	return &this
}
...
func (o ServiceDocsVoicemailGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsVoicemailGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsVoicemailGetAll struct {
	value *ServiceDocsVoicemailGetAll
	isSet bool
}

func (v NullableServiceDocsVoicemailGetAll) Get() *ServiceDocsVoicemailGetAll {
	return v.value
}

func (v *NullableServiceDocsVoicemailGetAll) Set(val *ServiceDocsVoicemailGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsVoicemailGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsVoicemailGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsVoicemailGetAll(val *ServiceDocsVoicemailGetAll) *NullableServiceDocsVoicemailGetAll {
	return &NullableServiceDocsVoicemailGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsVoicemailGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsVoicemailGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
