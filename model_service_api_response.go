...
// checks if the ServiceAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAPIResponse{}
...
func (o ServiceAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ServiceAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableServiceAPIResponse struct {
	value *ServiceAPIResponse
	isSet bool
}

func (v NullableServiceAPIResponse) Get() *ServiceAPIResponse {
	return v.value
}

func (v *NullableServiceAPIResponse) Set(val *ServiceAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceAPIResponse(val *ServiceAPIResponse) *NullableServiceAPIResponse {
	return &NullableServiceAPIResponse{value: val, isSet: true}
}

func (v NullableServiceAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
