...
// checks if the ServiceDocsCdrGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsCdrGetAll{}

// ServiceDocsCdrGetAll struct for ServiceDocsCdrGetAll
type ServiceDocsCdrGetAll struct {
	Data []ServiceCdrOutputShort `json:"data,omitempty"`
...
// SetData gets a reference to the given []ServiceCdrOutputShort and assigns it to the Data field.
...
func (o ServiceDocsCdrGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsCdrGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsCdrGetAll struct {
	value *ServiceDocsCdrGetAll
	isSet bool
}

func (v NullableServiceDocsCdrGetAll) Get() *ServiceDocsCdrGetAll {
	return v.value
}

func (v *NullableServiceDocsCdrGetAll) Set(val *ServiceDocsCdrGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsCdrGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsCdrGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsCdrGetAll(val *ServiceDocsCdrGetAll) *NullableServiceDocsCdrGetAll {
	return &NullableServiceDocsCdrGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsCdrGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsCdrGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
