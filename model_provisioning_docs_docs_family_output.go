...
// checks if the ProvisioningDocsDocsFamilyOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisioningDocsDocsFamilyOutput{}

// ProvisioningDocsDocsFamilyOutput struct for ProvisioningDocsDocsFamilyOutput
type ProvisioningDocsDocsFamilyOutput struct {
...
func NewProvisioningDocsDocsFamilyOutput() *ProvisioningDocsDocsFamilyOutput {
	this := ProvisioningDocsDocsFamilyOutput{}
	return &this
}
...
func (o ProvisioningDocsDocsFamilyOutput) MarshalJSON() ([]byte, error) {
...
func (o ProvisioningDocsDocsFamilyOutput) ToMap() (map[string]interface{}, error) {
...
type NullableProvisioningDocsDocsFamilyOutput struct {
	value *ProvisioningDocsDocsFamilyOutput
	isSet bool
}

func (v NullableProvisioningDocsDocsFamilyOutput) Get() *ProvisioningDocsDocsFamilyOutput {
	return v.value
}

func (v *NullableProvisioningDocsDocsFamilyOutput) Set(val *ProvisioningDocsDocsFamilyOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProvisioningDocsDocsFamilyOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProvisioningDocsDocsFamilyOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvisioningDocsDocsFamilyOutput(val *ProvisioningDocsDocsFamilyOutput) *NullableProvisioningDocsDocsFamilyOutput {
	return &NullableProvisioningDocsDocsFamilyOutput{value: val, isSet: true}
}

func (v NullableProvisioningDocsDocsFamilyOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvisioningDocsDocsFamilyOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
