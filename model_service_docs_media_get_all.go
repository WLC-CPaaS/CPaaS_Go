...
// checks if the ServiceDocsMediaGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsMediaGetAll{}

// ServiceDocsMediaGetAll struct for ServiceDocsMediaGetAll
type ServiceDocsMediaGetAll struct {
	Data []ServiceMediaOutputShort `json:"data,omitempty"`
...
func (o *ServiceDocsMediaGetAll) GetData() []ServiceMediaOutputShort {
	if o == nil || IsNil(o.Data) {
		var ret []ServiceMediaOutputShort
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ServiceMediaOutputShort and assigns it to the Data field.
...
func (o ServiceDocsMediaGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsMediaGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsMediaGetAll struct {
	value *ServiceDocsMediaGetAll
	isSet bool
}

func (v NullableServiceDocsMediaGetAll) Get() *ServiceDocsMediaGetAll {
	return v.value
}

func (v *NullableServiceDocsMediaGetAll) Set(val *ServiceDocsMediaGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsMediaGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsMediaGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsMediaGetAll(val *ServiceDocsMediaGetAll) *NullableServiceDocsMediaGetAll {
	return &NullableServiceDocsMediaGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsMediaGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsMediaGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
