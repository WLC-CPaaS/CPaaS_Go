...
// checks if the ProvisioningDocsDocsConfigFileOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisioningDocsDocsConfigFileOutput{}

// ProvisioningDocsDocsConfigFileOutput struct for ProvisioningDocsDocsConfigFileOutput
type ProvisioningDocsDocsConfigFileOutput struct {
...
func NewProvisioningDocsDocsConfigFileOutput() *ProvisioningDocsDocsConfigFileOutput {
	this := ProvisioningDocsDocsConfigFileOutput{}
	return &this
}
...
func (o ProvisioningDocsDocsConfigFileOutput) MarshalJSON() ([]byte, error) {
...
func (o ProvisioningDocsDocsConfigFileOutput) ToMap() (map[string]interface{}, error) {
...
type NullableProvisioningDocsDocsConfigFileOutput struct {
	value *ProvisioningDocsDocsConfigFileOutput
	isSet bool
}

func (v NullableProvisioningDocsDocsConfigFileOutput) Get() *ProvisioningDocsDocsConfigFileOutput {
	return v.value
}

func (v *NullableProvisioningDocsDocsConfigFileOutput) Set(val *ProvisioningDocsDocsConfigFileOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProvisioningDocsDocsConfigFileOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProvisioningDocsDocsConfigFileOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvisioningDocsDocsConfigFileOutput(val *ProvisioningDocsDocsConfigFileOutput) *NullableProvisioningDocsDocsConfigFileOutput {
	return &NullableProvisioningDocsDocsConfigFileOutput{value: val, isSet: true}
}

func (v NullableProvisioningDocsDocsConfigFileOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvisioningDocsDocsConfigFileOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
