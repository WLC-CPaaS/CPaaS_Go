...
// checks if the ServiceDocsMenuGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsMenuGetAll{}

// ServiceDocsMenuGetAll struct for ServiceDocsMenuGetAll
type ServiceDocsMenuGetAll struct {
	Data []ServiceMenuOutputShort `json:"data,omitempty"`
...
func (o *ServiceDocsMenuGetAll) GetData() []ServiceMenuOutputShort {
	if o == nil || IsNil(o.Data) {
		var ret []ServiceMenuOutputShort
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ServiceMenuOutputShort and assigns it to the Data field.
...
func (o ServiceDocsMenuGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsMenuGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsMenuGetAll struct {
	value *ServiceDocsMenuGetAll
	isSet bool
}

func (v NullableServiceDocsMenuGetAll) Get() *ServiceDocsMenuGetAll {
	return v.value
}

func (v *NullableServiceDocsMenuGetAll) Set(val *ServiceDocsMenuGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsMenuGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsMenuGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsMenuGetAll(val *ServiceDocsMenuGetAll) *NullableServiceDocsMenuGetAll {
	return &NullableServiceDocsMenuGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsMenuGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsMenuGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
