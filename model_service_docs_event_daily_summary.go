...
// checks if the ServiceDocsEventDailySummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsEventDailySummary{}

// ServiceDocsEventDailySummary struct for ServiceDocsEventDailySummary
type ServiceDocsEventDailySummary struct {
	Data []ModelEventDailySummary `json:"data,omitempty"`
...
func NewServiceDocsEventDailySummary() *ServiceDocsEventDailySummary {
	this := ServiceDocsEventDailySummary{}
	return &this
}
...
func (o *ServiceDocsEventDailySummary) GetData() []ModelEventDailySummary {
	if o == nil || IsNil(o.Data) {
		var ret []ModelEventDailySummary
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ModelEventDailySummary and assigns it to the Data field.
...
func (o ServiceDocsEventDailySummary) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsEventDailySummary) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsEventDailySummary struct {
	value *ServiceDocsEventDailySummary
	isSet bool
}

func (v NullableServiceDocsEventDailySummary) Get() *ServiceDocsEventDailySummary {
	return v.value
}

func (v *NullableServiceDocsEventDailySummary) Set(val *ServiceDocsEventDailySummary) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsEventDailySummary) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsEventDailySummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsEventDailySummary(val *ServiceDocsEventDailySummary) *NullableServiceDocsEventDailySummary {
	return &NullableServiceDocsEventDailySummary{value: val, isSet: true}
}

func (v NullableServiceDocsEventDailySummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsEventDailySummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
