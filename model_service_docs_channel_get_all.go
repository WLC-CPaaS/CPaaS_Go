...
// checks if the ServiceDocsChannelGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsChannelGetAll{}

// ServiceDocsChannelGetAll struct for ServiceDocsChannelGetAll
type ServiceDocsChannelGetAll struct {
...
func (o ServiceDocsChannelGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsChannelGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsChannelGetAll struct {
	value *ServiceDocsChannelGetAll
	isSet bool
}

func (v NullableServiceDocsChannelGetAll) Get() *ServiceDocsChannelGetAll {
	return v.value
}

func (v *NullableServiceDocsChannelGetAll) Set(val *ServiceDocsChannelGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsChannelGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsChannelGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsChannelGetAll(val *ServiceDocsChannelGetAll) *NullableServiceDocsChannelGetAll {
	return &NullableServiceDocsChannelGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsChannelGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsChannelGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
