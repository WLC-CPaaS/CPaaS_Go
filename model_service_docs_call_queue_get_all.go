...
// checks if the ServiceDocsCallQueueGetAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsCallQueueGetAll{}

// ServiceDocsCallQueueGetAll struct for ServiceDocsCallQueueGetAll
type ServiceDocsCallQueueGetAll struct {
	Data []ServiceCallQueueOutputShort `json:"data,omitempty"`
...
func NewServiceDocsCallQueueGetAll() *ServiceDocsCallQueueGetAll {
	this := ServiceDocsCallQueueGetAll{}
	return &this
}
...
func (o *ServiceDocsCallQueueGetAll) GetData() []ServiceCallQueueOutputShort {
	if o == nil || IsNil(o.Data) {
		var ret []ServiceCallQueueOutputShort
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ServiceCallQueueOutputShort and assigns it to the Data field.
...
func (o ServiceDocsCallQueueGetAll) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsCallQueueGetAll) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsCallQueueGetAll struct {
	value *ServiceDocsCallQueueGetAll
	isSet bool
}

func (v NullableServiceDocsCallQueueGetAll) Get() *ServiceDocsCallQueueGetAll {
	return v.value
}

func (v *NullableServiceDocsCallQueueGetAll) Set(val *ServiceDocsCallQueueGetAll) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsCallQueueGetAll) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsCallQueueGetAll) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsCallQueueGetAll(val *ServiceDocsCallQueueGetAll) *NullableServiceDocsCallQueueGetAll {
	return &NullableServiceDocsCallQueueGetAll{value: val, isSet: true}
}

func (v NullableServiceDocsCallQueueGetAll) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsCallQueueGetAll) UnmarshalJSON(src []byte) error {
	v.isSet = true
