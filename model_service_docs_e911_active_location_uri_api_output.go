...
// checks if the ServiceDocsE911ActiveLocationURIApiOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsE911ActiveLocationURIApiOutput{}

// ServiceDocsE911ActiveLocationURIApiOutput struct for ServiceDocsE911ActiveLocationURIApiOutput
type ServiceDocsE911ActiveLocationURIApiOutput struct {
...
func NewServiceDocsE911ActiveLocationURIApiOutput() *ServiceDocsE911ActiveLocationURIApiOutput {
	this := ServiceDocsE911ActiveLocationURIApiOutput{}
	return &this
}
...
func (o ServiceDocsE911ActiveLocationURIApiOutput) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsE911ActiveLocationURIApiOutput) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsE911ActiveLocationURIApiOutput struct {
	value *ServiceDocsE911ActiveLocationURIApiOutput
	isSet bool
}

func (v NullableServiceDocsE911ActiveLocationURIApiOutput) Get() *ServiceDocsE911ActiveLocationURIApiOutput {
	return v.value
}

func (v *NullableServiceDocsE911ActiveLocationURIApiOutput) Set(val *ServiceDocsE911ActiveLocationURIApiOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsE911ActiveLocationURIApiOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsE911ActiveLocationURIApiOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsE911ActiveLocationURIApiOutput(val *ServiceDocsE911ActiveLocationURIApiOutput) *NullableServiceDocsE911ActiveLocationURIApiOutput {
	return &NullableServiceDocsE911ActiveLocationURIApiOutput{value: val, isSet: true}
}

func (v NullableServiceDocsE911ActiveLocationURIApiOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsE911ActiveLocationURIApiOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
