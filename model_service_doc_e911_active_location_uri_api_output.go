...
// checks if the ServiceDocE911ActiveLocationURIApiOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocE911ActiveLocationURIApiOutput{}

// ServiceDocE911ActiveLocationURIApiOutput struct for ServiceDocE911ActiveLocationURIApiOutput
type ServiceDocE911ActiveLocationURIApiOutput struct {
...
func NewServiceDocE911ActiveLocationURIApiOutput() *ServiceDocE911ActiveLocationURIApiOutput {
	this := ServiceDocE911ActiveLocationURIApiOutput{}
	return &this
}
...
func (o ServiceDocE911ActiveLocationURIApiOutput) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocE911ActiveLocationURIApiOutput) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocE911ActiveLocationURIApiOutput struct {
	value *ServiceDocE911ActiveLocationURIApiOutput
	isSet bool
}

func (v NullableServiceDocE911ActiveLocationURIApiOutput) Get() *ServiceDocE911ActiveLocationURIApiOutput {
	return v.value
}

func (v *NullableServiceDocE911ActiveLocationURIApiOutput) Set(val *ServiceDocE911ActiveLocationURIApiOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocE911ActiveLocationURIApiOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocE911ActiveLocationURIApiOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocE911ActiveLocationURIApiOutput(val *ServiceDocE911ActiveLocationURIApiOutput) *NullableServiceDocE911ActiveLocationURIApiOutput {
	return &NullableServiceDocE911ActiveLocationURIApiOutput{value: val, isSet: true}
}

func (v NullableServiceDocE911ActiveLocationURIApiOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocE911ActiveLocationURIApiOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
