...
// checks if the ServiceDocsFeatureMonthlySummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceDocsFeatureMonthlySummary{}

// ServiceDocsFeatureMonthlySummary struct for ServiceDocsFeatureMonthlySummary
type ServiceDocsFeatureMonthlySummary struct {
	Data []ModelFeatureMonthlySummary `json:"data,omitempty"`
...
func NewServiceDocsFeatureMonthlySummary() *ServiceDocsFeatureMonthlySummary {
	this := ServiceDocsFeatureMonthlySummary{}
	return &this
}
...
func (o *ServiceDocsFeatureMonthlySummary) GetData() []ModelFeatureMonthlySummary {
	if o == nil || IsNil(o.Data) {
		var ret []ModelFeatureMonthlySummary
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ModelFeatureMonthlySummary and assigns it to the Data field.
...
func (o ServiceDocsFeatureMonthlySummary) MarshalJSON() ([]byte, error) {
...
func (o ServiceDocsFeatureMonthlySummary) ToMap() (map[string]interface{}, error) {
...
type NullableServiceDocsFeatureMonthlySummary struct {
	value *ServiceDocsFeatureMonthlySummary
	isSet bool
}

func (v NullableServiceDocsFeatureMonthlySummary) Get() *ServiceDocsFeatureMonthlySummary {
	return v.value
}

func (v *NullableServiceDocsFeatureMonthlySummary) Set(val *ServiceDocsFeatureMonthlySummary) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceDocsFeatureMonthlySummary) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceDocsFeatureMonthlySummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceDocsFeatureMonthlySummary(val *ServiceDocsFeatureMonthlySummary) *NullableServiceDocsFeatureMonthlySummary {
	return &NullableServiceDocsFeatureMonthlySummary{value: val, isSet: true}
}

func (v NullableServiceDocsFeatureMonthlySummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceDocsFeatureMonthlySummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
